class_name ReversibleRigidBody3D extends RigidBody3D

var _position_buffer: PackedVector3Array
var _rotation_buffer: PackedVector3Array
var _linear_velocity_buffer : PackedVector3Array
var _angular_velocity_buffer : PackedVector3Array
